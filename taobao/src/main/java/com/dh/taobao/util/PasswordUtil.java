...
public class PasswordUtil {
    public static final Logger log = LogManager.getLogger(com.dh.taobao.util.PasswordUtil.class);
    /**
    ...
    private static Key getPBEKey(String password) {
        ...
        try {
            ...
            log.error("PasswordUtil getPBEKey err", e);
        }
    ...
    public static String decrypt(String ciphertext, String password) {
        ...
        //mod Deng Ye 2020-8-25 16:08:21
        assert passDec != null;
    ...
    public static void main(String[] args) {
        ...
        String password = "123";
        System.out.println(encrypt(username, password, PasswordUtil.getStaticSalt()));
    }
}